...
# create the model
encoder = keras.models.Sequential()
encoder.add(keras.layers.Conv1D(1024, kernel_size=512, strides=4, activation='relu',input_shape=input_shape, padding='same'))
encoder.add(keras.layers.MaxPooling1D(2))
encoder.add(keras.layers.Dropout(0.3))
encoder.add(keras.layers.BatchNormalization())
encoder.add(keras.layers.Conv1D(128, kernel_size=64, strides=1, activation='relu', padding='same'))
encoder.add(keras.layers.Dropout(0.3))
encoder.add(keras.layers.BatchNormalization())
encoder.add(keras.layers.MaxPooling1D(2))
encoder.add(keras.layers.Conv1D(128, kernel_size=64, strides=1, activation='relu', padding='same'))
...
encoder.add(keras.layers.BatchNormalization())
encoder.add(keras.layers.MaxPooling1D(2))
encoder.add(keras.layers.Conv1D(256, kernel_size=64, strides=1, activation='relu', padding='same'))
encoder.add(keras.layers.Dropout(0.3))
encoder.add(keras.layers.BatchNormalization())
encoder.add(keras.layers.MaxPooling1D(2))
encoder.add(keras.layers.Conv1D(512, kernel_size=64, strides=1, activation='relu', padding='same'))
encoder.add(keras.layers.Dropout(0.3))
encoder.add(keras.layers.BatchNormalization())
encoder.add(keras.layers.MaxPooling1D(2))
encoder.add(keras.layers.Flatten())
